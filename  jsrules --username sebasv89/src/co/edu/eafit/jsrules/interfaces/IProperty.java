...
/**
 * <p>This class defines the services for getting and saving properties in to the component.</p>
 * <p>The constants for properties are defined in PropertiesConstants.java</p>
 * <p>The script generation process reads the properties in order to customize the javascript result. </p>
...
public interface IProperty extends Service {
	 ...
	 * <li>The property key and the property value are allowed values. (Defined in PropertyConstants class)</li>
	 * </ol>
	 * </p>
	 * <p>Postconditions:
	 * <ol>
